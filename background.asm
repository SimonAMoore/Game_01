...
{
    .start
    equb &00, &00, &00, &00, &01, &01, &00, &00, &01, &01, &00, &00
...
{
    .start
    equb (COL_BLACK EOR 7), &20 + (COL_GREEN EOR 7),  &80 + (COL_YELLOW EOR 7),  &A0 + (COL_WHITE EOR 7)
    equb (COL_BLUE EOR 7),  &20 + (COL_GREEN EOR 7),  &80 + (COL_RED EOR 7),     &A0 + (COL_WHITE EOR 7)
    equb (COL_BLUE EOR 7),  &20 + (COL_GREEN EOR 7),  &80 + (COL_RED EOR 7),     &A0 + (COL_WHITE EOR 7)
    equb (COL_BLUE EOR 7),  &20 + (COL_GREEN EOR 7),  &80 + (COL_RED EOR 7),     &A0 + (COL_WHITE EOR 7)
    equb (COL_BLUE EOR 7),  &20 + (COL_GREEN EOR 7),  &80 + (COL_RED EOR 7),     &A0 + (COL_WHITE EOR 7)
    equb (COL_BLUE EOR 7),  &20 + (COL_GREEN EOR 7),  &80 + (COL_RED EOR 7),     &A0 + (COL_WHITE EOR 7)
    ...
    equb (COL_BLUE EOR 7),  &20 + (COL_GREEN EOR 7),  &80 + (COL_RED EOR 7),     &A0 + (COL_WHITE EOR 7)
    equb (COL_BLUE EOR 7),  &20 + (COL_GREEN EOR 7),  &80 + (COL_RED EOR 7),     &A0 + (COL_WHITE EOR 7)
    equb (COL_BLACK EOR 7), &20 + (COL_GREEN EOR 7),  &80 + (COL_RED EOR 7),     &A0 + (COL_WHITE EOR 7)
    equb (COL_BLACK EOR 7), &20 + (COL_GREEN EOR 7),  &80 + (COL_MAGENTA EOR 7), &A0 + (COL_CYAN EOR 7)
    equb (COL_BLACK EOR 7), &20 + (COL_GREEN EOR 7),  &80 + (COL_MAGENTA EOR 7), &A0 + (COL_CYAN EOR 7)
    equb (COL_BLACK EOR 7), &20 + (COL_GREEN EOR 7),  &80 + (COL_RED EOR 7),     &A0 + (COL_WHITE EOR 7)
    equb (COL_BLACK EOR 7), &20 + (COL_GREEN EOR 7),  &80 + (COL_RED EOR 7),     &A0 + (COL_WHITE EOR 7)
    equb (COL_BLACK EOR 7), &20 + (COL_GREEN EOR 7),  &80 + (COL_RED EOR 7),     &A0 + (COL_WHITE EOR 7)
